...
res_overall_df$significant <- res_overall_df$padj < 0.1 & !is.na(res_overall_df$padj)
...
ggsave("MA_plot_overall_labeled.png", width = 10, height = 7, dpi = 300)